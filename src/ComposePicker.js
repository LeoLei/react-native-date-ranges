...
export default class ComposePicker extends Component {
  ...
  onConfirm = () => {
    ...
    if (this.state.startDate && this.state.endDate) {
      ...
      if(this.props.errorAlertText) {
        alert(this.props.errorAlertText);
      }      
    }
  };
  getTitleElement() {
    ...
    return (
      ...
      >
        <Text style={[{ fontSize: 20 }, this.props.ButtonTextStyle]}>
          {this.props.ButtonText ? this.props.ButtonText : '确认'}
        </Text>
      </TouchableHighlight>
    );
  };
            ...
            <View stlye={{ flex: 1, flexDirection: 'column' }}>
              <View style={{ height: '90%' }}>
                <DateRange
                  ...
                  calendarTitleFormat={this.props.calendarTitleFormat}
